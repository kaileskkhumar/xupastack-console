...
const frameworks = [
  ...
  {
    name: "Flutter",
    env: `const supabaseUrl = 'https://your-ref.xupastack.dev';\nconst supabaseAnonKey = 'your-anon-key';`,
